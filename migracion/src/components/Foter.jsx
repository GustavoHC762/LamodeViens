  ...
  return (
    <>
      <footer className="container-fluid">
        <div className="row">
          <div className="animate__animated animate__pulse col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3 anmpijam">
            <img src={logo} alt="logo de la pagina" width="200" />
          </div>
          ...
          <div className="animate__animated animate__pulse col-3 anmpijam">
