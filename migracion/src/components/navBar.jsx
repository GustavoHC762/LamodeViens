...
const NavBar = () =>{
  return(
    ...
    <section className="container-fluid">
      <div className="row">
        <p id="nosotros" className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 sobrenosotrosp"><span className="lmdvs">La mode viends </span>es una tienda online creada para un proyecto estudiantil para poder hacerle mas facil la compra de distienta ropa a nuestros clientes, por el momento nosotros solo trabajamos con envios contra entrega a nivel de <span className="lmdvs">BOGOTA </span>y resto del pais por envios via efecti, srvientrega, etc</p>
      </div>
    </section>
    </>
  )
